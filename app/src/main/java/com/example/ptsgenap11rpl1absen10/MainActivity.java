...
public class MainActivity extends AppCompatActivity {
    ...
    public void aksiButton(){
        btnTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String nama = etNamaBarang.getText().toString(); //mengambil Value etNim menjadi string
    ...
    public void tambahData(String kode, String nama, String jenis){
        ...
        AndroidNetworking.post("http://192.168.0.112/crud/create.php")
                .addBodyParameter("b_id", "") //id bersifat Auto_Increment tidak perlu diisi/(diisi NULL) cek create.php
                .addBodyParameter("b_kode",kode) //mengirimkan data nim_mahasiswa yang akan diisi dengan varibel nim
                .addBodyParameter("b_nama", nama) //mengirimkan data nama_mahasiswa yang akan diisi dengan varibel nama
                .addBodyParameter("b_jenis", jenis) //mengirimkan data kelas_mahasiswa yang akan diisi dengan varibel kelas
