...
public class ReadAllActivity extends AppCompatActivity {
    ...
    public void getData(){
        ...
        AndroidNetworking.get("http://192.168.0.112/crud/read.php")
                        ...
                        // do anything with response
                        {
                            ...
                            try {
                                for (int i = 0; i < response.length(); i++) {
                                    ...
                                    item.setb_id(data.getString("b_id"));
                                    item.setb_kode(data.getString("b_kode"));
                                    item.setb_jenis(data.getString("b_jenis"));
                                    item.setb_nama(data.getString("b_nama"));
