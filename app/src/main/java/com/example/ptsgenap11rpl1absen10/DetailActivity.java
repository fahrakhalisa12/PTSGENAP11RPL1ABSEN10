    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AndroidNetworking.post("http://192.168.0.112/crud/update.php")
                        .addBodyParameter("b_id", getIntent().getStringExtra("events")) //id bersifat Auto_Increment tidak perlu diisi/(diisi NULL) cek create.php
                        .addBodyParameter("b_kode",etKode.getText().toString().trim().toUpperCase()) //mengirimkan data nim_mahasiswa yang akan diisi dengan varibel nim
                        .addBodyParameter("b_nama", etNamaBarang.getText().toString().trim().toUpperCase()) //mengirimkan data nama_mahasiswa yang akan diisi dengan varibel nama
                        .addBodyParameter("b_jenis", etJenis.getText().toString().trim().toUpperCase()) //mengirimkan data kelas_mahasiswa yang akan diisi dengan varibel kelas
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AndroidNetworking.initialize(getApplicationContext()); //inisialisasi library FAN
                AndroidNetworking.post("http://192.168.0.112/crud/delete.php")
                        .addBodyParameter("b_id", getIntent().getStringExtra("events")) //id bersifat Auto_Increment tidak perlu diisi/(diisi NULL) cek create.php
                        .setPriority(Priority.MEDIUM)
                        .build()
                        .getAsJSONObject(new JSONObjectRequestListener() {
